...
Use these patterns as guides, not as formulas to apply blindly.
...
**Why**  
The revision removes generic value language and keeps only what the text can support.
...
**Why**  
The revision replaces broad field-level praise with a concrete reason tied to the paper's setup.
...
**Why**  
The revision keeps the conclusion proportional to the evidence and avoids grand impact language.
...
**Why**  
The transition added polish without information. Removing it improves rhythm and reduces template feel.
...
**Why**  
The revision preserves the positive result while removing unsupported scope expansion.
...
**Why**  
The revision keeps professional fit language but removes exaggerated deference and self-promotion.
...
**Why**  
The revision shifts from canned politeness to concrete response content without sounding rude.
