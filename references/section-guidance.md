...
- Keep: exact task, method, evidence, and scope
...
- Keep: problem framing, gap statement, and contribution logic
...
- Avoid: paraphrases that could shift definitions, procedure, or assumptions
...
- Avoid: smoothing that blurs uncertainty, magnitude, or comparison basis
...
- Remove: generic "in summary" style endings and broad claims unsupported by results
